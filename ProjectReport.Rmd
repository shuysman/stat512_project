...
Initially, we can look at a box plot of the raw data to see if growth rates may vary between planting units. Figure \@ref(fig:rawEDA) shows that there might be slight differences between the planting units, especially for the West Yellowstone (WY) unit. However, any apparent differences may be a result of a difference in the age of the seedlings. 
