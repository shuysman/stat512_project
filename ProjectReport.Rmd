...
```{r fig1, fig.cap = "a figure", echo = FALSE, out.width = '50%', fig.align='center'}
...
- Explanatory variables are as follows: 
  ...
  - PICO - Presence of *Pinus contorta* within 3.59m radius of WBP. 1 if PICO is present, 0 othwerise.
  - PIEN - Presence of *Pinus engelmannii* within 3.59m radius of WBP. 1 if PIEN is present, 0 othwerise.
  - ABLA - Presence of *Abies lasiocarpa* within 3.59m radius of WBP. 1 if ABLA is present, 0 othwerise.
