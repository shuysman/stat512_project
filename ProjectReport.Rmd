...
From examination of the raw data, there appears to be unequal variance in growth rate by planting unit.  This suggests that a log transformation be applied, and the variances look equal after transformation (Figure \@ref(fig:fig4)).
...
- run initial full model with cubic functions and factors for micro, PICO, ALBA, etc. 
- use backwards step to find final model
- report final model in paper 
- talk about 
...
The final model suggests the WBP seedling growth is most correlated with the annual evapotranspiration, the potential evapotranspirtaion, and the number of competitors around the seedling, while accounting for the random effect of planting unit. The cubic forms of these variables suggest  
