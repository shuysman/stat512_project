...
```{r fig2, fig.cap = "Hierarchical study design with fixed and random effects.", echo = FALSE, out.width = '75%', fig.align='center'}
...
```{r fig4, echo = FALSE, eval = TRUE, warnings = FALSE, fig.cap="Growth rate by unit", fig.height = 3}
#need to make a different raw data visualization plot, if we want to include it
fig4
```
...
Description  Full            AICc    
------------ ------          -----
full         $growth_{rate}$ 2341

+---------------+----------------------------------------------------------------------------+-----------------------------+
| Description   | Full                                                                       | AICc                        |
+===============+============================================================================+=============================+
| Full          | $growth\_rate = aet^3 + comp\_{number}^3 + CWD + unit + (1 | site)$        | `r AICc(model_of_interest)` |
|               |               | - bright color     |
+---------------+---------------+--------------------+
| Reduced       | $2.10         | - cures scurvy     |
|               |               | - tasty            |
+---------------+---------------+--------------------+
