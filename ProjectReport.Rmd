...
#NEED TO FIX LAUFENBERG SO WE CAN USE IT AS SOURCE, too many warnings and stuff. or we can create a different source document
#source("laufenberg.R")
#fig4
```
